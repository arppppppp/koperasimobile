...
class _MainScreenWrapperState extends State<MainScreenWrapper> {
  ...
  // Improved bottom navigation bar with no circular home button
    ...
    return Container(
      ...
      child: ClipRRect(
        ...
        child: BottomNavigationBar(
          ...
          selectedIconTheme: IconThemeData(size: 30), // Ukuran icon saat dipilih
          unselectedIconTheme: IconThemeData(size: 22), // Ukuran icon saat tidak dipilih
          elevation: 0,
          items: const [
